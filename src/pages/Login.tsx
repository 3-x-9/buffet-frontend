...
import { LogIn, Mail, Lock, ChevronRight, AlertCircle, CheckCircle } from 'lucide-react';
            ...
            <div className="w-full max-w-md bg-[var(--bg-surface)] rounded-[3rem] p-10 border border-[var(--border-subtle)] shadow-2xl relative overflow-hidden transition-colors duration-300">
                ...
                <div className="relative">
                    <div className="flex flex-col items-center mb-10">
                        ...
                        <h1 className="text-3xl font-black uppercase italic tracking-tighter text-[var(--text-primary)]">Welcome Back</h1>
                        <p className="text-[var(--text-secondary)] text-xs font-bold uppercase tracking-widest mt-2">Sign in to your account</p>
                    </div>
                    ...
                    <p className="mt-8 text-center text-sm font-bold text-[var(--text-secondary)]">
                        ...
                        <Link to="/register" className="text-amber-500 hover:underline">Create one here</Link>
                    </p>
                </div>
            </div>
        </div>
